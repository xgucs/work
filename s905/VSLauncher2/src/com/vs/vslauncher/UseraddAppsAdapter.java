...
public class UseraddAppsAdapter extends BaseAdapter
{
	...
	public UseraddAppsAdapter(Context context)
	{
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		if (convertView == null) 
		{
			...
			holder.iconadd = (ImageView)convertView.findViewById(R.id.imageView1);
		...
		holder.iconadd.setImageResource(position==0?
				R.drawable.user_app_remove:R.drawable.user_app_change);
